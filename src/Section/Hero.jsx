...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden px-4 sm:px-6">
      ...
      >
        {/* Animated Badge */}
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-zinc-800 bg-zinc-900/50 mb-6 md:mb-8">
        ...
        <motion.h1 variants={itemVariants} className="text-4xl sm:text-6xl lg:text-8xl font-bold tracking-tight mb-6 px-2">
          I craft <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-500">digital</span> <br className="hidden sm:block" /> 
          <span className="italic font-serif text-blue-500">masterpieces</span>
        </motion.h1>

        {/* Subtext: Adjusted width and size for readability */}
        <motion.p variants={itemVariants} className="max-w-xs sm:max-w-md md:max-w-xl mx-auto text-zinc-400 text-base md:text-xl leading-relaxed mb-8 md:mb-10 px-4">
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-4 px-6">
          ...
          <button className="w-full sm:w-auto px-8 py-4 rounded-full border border-zinc-800 text-white font-medium hover:bg-zinc-900 transition-colors flex items-center justify-center gap-2">
